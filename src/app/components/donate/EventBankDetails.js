...
export function EventBankDetails() {
  const bankDetails = [
    { label: "Bank Name", value: "Saraswat Bank" },
    { label: "Account Number", value: "403200100000929" },
    { label: "IFSC Code", value: "SRCB0000403" },
    { label: "Branch", value: "Khopat" },
  ];
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 mt-4 sm:mt-8 items-center justify-center">
      ...
      <div className="flex items-center justify-center">
        <Image
          src="/qr-code-event.jpeg"
          alt="QR Code for Event Payment"
          width={400}
          height={400}
          priority
        />
...
export default EventBankDetails;
